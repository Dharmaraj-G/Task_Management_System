...
public class UpdateCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        returms = findViewById(R.id.buttoned);
        imageviews=findViewById(R.id.imager);
        ...
        imageviews.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String uri = "tel:" + courseDescriptionEdt.getText().toString().trim();
        ...
        returms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent noise=new Intent(UpdateCourseActivity.this,MainActivity2.class);
                startActivity(noise);
            }
        });
